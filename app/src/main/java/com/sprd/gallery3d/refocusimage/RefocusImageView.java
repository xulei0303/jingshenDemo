    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mReset) {
            if (mSrcBitmap != null && mDisplaySrcMatrix != null) {
                Log.d(TAG,"onDraw mDisplaySrcMatrix1  = "+mDisplaySrcMatrix);
                canvas.drawBitmap(mSrcBitmap, mDisplaySrcMatrix, null);
            }
        } else {
            if (mRefocusBitmap != null && mDisplaySrcMatrix != null) {
                Log.d(TAG,"onDraw mDisplaySrcMatrix2  = "+mDisplaySrcMatrix);
                canvas.drawBitmap(mRefocusBitmap, mDisplaySrcMatrix, null);
            }
        }
